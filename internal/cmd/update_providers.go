...
star update-providers

# Update Catwalk providers from a custom URL
star update-providers https://example.com/providers.json

# Update Catwalk providers from a local file
star update-providers /path/to/local-providers.json

# Update Catwalk providers from embedded version
star update-providers embedded

# Update Hyper provider information
star update-providers --source=hyper

# Update Hyper from a custom URL
star update-providers --source=hyper https://hyper.example.com
`,
